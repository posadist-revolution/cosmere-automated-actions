 ...
 * - preCompleteGoal
 */
export type UseItem = (item: CosmereItem, options: CosmereItem.UseOptions) => void;
export type PreUseItem = (item: CosmereItem, options: CosmereItem.UseOptions) => boolean;
 ...
 */
export type PreProgressGoal = (item: CosmereItem, newProgress: number) => boolean;
/**
 ...
 */
export type PreUpdateProgressGoal = (item: CosmereItem, newProgress: number) => boolean;
/**
